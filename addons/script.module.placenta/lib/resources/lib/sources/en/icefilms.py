...
class source:
    def __init__(self):
        self.priority = 0
        self.language = ['en']
        self.domains = ['icefilms.info','icefilms.unblocked.tv']
        self.base_url = 'https://icefilms.unblocked.tv'
    ...
    def movie(self, imdb, title, localtitle, aliases, year):
        try:
            ...
            headers = {'Host': 'icefilms.unblocked.tv',
            ...
            for fragment in dom_parser2.parse_dom(html, 'div', {'class': 'ripdiv'}):
                ...
                for match in re.finditer(pattern, fragment.content):
                    ...
                    headers =  {'Host': 'icefilms.unblocked.tv',
                                'Connection': 'keep-alive',
                                'Content-Length': '65',
                                'Origin': 'https://icefilms.unblocked.tv',
                                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.100 Safari/537.36',
