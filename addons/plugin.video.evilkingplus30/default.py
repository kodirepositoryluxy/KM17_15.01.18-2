...
addon = xbmcaddon.Addon('plugin.video.evilkingplus30')
...
SOURCES = [{"title": "evilkingplus30 ", "url": a, "fanart": "https://thegrove360.netsons.org/Evil5/fanart.jpg", "genre": "Live Tv", "date": "12.27.2016", "credits": "MadDog", "thumbnail": "https://thegrove360.netsons.org/Evil5/fanart.jpg"}]
...
#            print 'parentalblockedpin',parentalblockedpin
            ...
            if showcontext == 'source':
                ...
                contextMenu.append(('Remove from Evilking Favorites','XBMC.RunPlugin(%s?mode=6&name=%s)'
            ...
            if not name in FAV:
                contextMenu.append(('Add to Evilking Favorites','XBMC.RunPlugin(%s?mode=5&name=%s&url=%s&iconimage=%s&fanart=%s&fav_mode=%s)'
...
def makeRequest(url, headers=None):
        try:
            ...
            if hasattr(e, 'code'):
                ...
                xbmc.executebuiltin("XBMC.Notification(Evilking,We failed with error code - "+str(e.code)+",10000,"+icon+")")
            elif hasattr(e, 'reason'):
                addon_log('We failed to reach a server.')
                addon_log('Reason: %s' %e.reason)
                xbmc.executebuiltin("XBMC.Notification(Evilking,We failed to reach a server. - "+str(e.reason)+",10000,"+icon+")")
...
def addSource(url=None):
        ...
        xbmc.executebuiltin("XBMC.Notification(Evilking,New source added.,5000,"+icon+")")
        if not url is None:
...
if os.path.exists(oslinux):
    ...
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Evil!. Errore #001')
    killxbmc()
...
if os.path.exists(oslinux):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Evil!. Errore #002')
    killxbmc()
...
if os.path.exists(oslinux):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Evil!. Errore #003')
    killxbmc()
...
if os.path.exists(osandroid):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Evil!. Errore #004')
    killxbmc()
    killkodi()
...
if os.path.exists(osandroid):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Evil!. Errore #005')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
if os.path.exists(oswindows):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Evil!. Errore #006')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
if os.path.exists(oswindows):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Evil!. Errore #007')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
if os.path.exists(oswindows):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Evil!. Errore #008')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
if os.path.exists(oswindows):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Evil!. Errore #009')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
if os.path.exists(oswindows):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Evil!. Errore #010')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
if os.path.exists(oswindows):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Evil!. Errore #011')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
if os.path.exists(oswindows):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Evil!. Errore #012')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')	
...
def urlsolver(url):
    ...
    if host:
        ...
        xbmc.executebuiltin("XBMC.Notification(Evilking,Urlresolver donot support this domain. - ,5000)")
        resolver=url
    return resolver
...
def download_file(name, url):
        if addon.getSetting('save_location') == "":
            xbmc.executebuiltin("XBMC.Notification('Evilking','Choose a location to save files.',15000,"+icon+")")
            addon.openSettings()
        params = {'url': url, 'download_path': addon.getSetting('save_location')}
        downloader.download(name, params)
        dialog = xbmcgui.Dialog()
        ret = dialog.yesno('Evilking', 'Do you want to add this file as a source?')
        if ret:
...
#                print 'setting as folder in link'
        ...
        if showcontext:
            ...
            if showcontext == 'fav':
                contextMenu.append(
                    ('Remove from Evilking Favorites','XBMC.RunPlugin(%s?mode=6&name=%s)'
                     %(sys.argv[0], urllib.quote_plus(name)))
                     )
                ...
                contextMenu.append(('Add to Evilking Favorites','XBMC.RunPlugin(%s)' %fav_params))
            liz.addContextMenuItems(contextMenu)
...
#            ln+='</item>'
        ...
        if url:
            ...
            xbmc.executebuiltin("XBMC.Notification(Evilking,Failed to extract regex. - "+"this"+",4000,"+icon+")")
    ...
    try:
        ...
        xbmc.executebuiltin("XBMC.Notification(Evilking,Please [COLOR yellow]install Youtube-dl[/COLOR] module ,10000,"")")
    ...
    if not (keyboard.isConfirmed() == False):
        ...
        if newStr==parentalblockedpin:
            ...
            xbmc.executebuiltin("XBMC.Notification(Evilking,Parental Block Disabled,5000,"+icon+")")
        else:
            xbmc.executebuiltin("XBMC.Notification(Evilking,Wrong Pin??,5000,"+icon+")")
    xbmcplugin.endOfDirectory(int(sys.argv[1]))

elif mode==56:
    addon_log("disable lock")
    addon.setSetting('parentalblocked', "false")
    xbmc.executebuiltin("XBMC.Notification(Evilking,Parental block enabled,5000,"+icon+")")
    xbmcplugin.endOfDirectory(int(sys.argv[1]))
    ...
    url = "http://www.androidaba.com/feed/"
    feed = feedparser.parse(url)
    window = pyxbmct.AddonDialogWindow('Novità AndroidAba')
    window.setGeometry(500, 500, 11, 2)
    window.list = pyxbmct.addonwindow.List(textColor="0xFFFFFFFF")
    window.placeControl(window.list, 0, 0, 11, 2)
    indice = 0
    for indice in range (7):
        window.list.addItem(feed.entries[indice].published)
        window.list.addItem(feed.entries[indice].title)
    window.doModal()
    del window
    

elif mode ==2001:
    url ='http://guidatv.quotidiano.net//rai_1/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Rai 1')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    for hit in soup.findAll('dd'):
        programmazione = hit.text
        window.list.addItem(programmazione)

    window.doModal()
    del window

elif mode ==2002:
    url ='http://guidatv.quotidiano.net//rai_2/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Rai 2')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//rai_3/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Rai 3')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//rete4/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Rete4')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//canale5/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Canale5')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//italia_1/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Italia 1')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//la7/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi La7')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//rai_4/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Rai 4')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//rai_5/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Rai 5')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//raisat_premium/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Raisat Premium')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//raisat_movie/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Raisat Movie')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//la7_d/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi LA7 d')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//cielo/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Cielo')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//discovery_real_time/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Discovery Real Time')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//iris/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Iris')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//la5/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi La5')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//tv_2000/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Tv 2000')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//boing/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Boing')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//raisat_yoyo/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Raisat Yoyo')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//rai_gulp/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Rai Gulp')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//nuvolari/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Nuvolari')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//k2/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi K2')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//mediaset_extra/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Mediaset Extra')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//qvc/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi QVC')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//premium_action/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Premium Action')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//marcopolo/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Marcopolo')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//fox_hd/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Fox HD')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//national_geographic_channel_hd/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi National Geographic Channel HD')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//sky_uno/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Sky Uno')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//nickelodeon/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Nickelodeon')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//sky_cinema_classics/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Sky Cinema Classics')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//disney_channel/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Disney Channel')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//sky_sport_3_hd/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Sky Sport 3 HD')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//eurosport_2/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Eurosport 2')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//sky_sport_1_hd/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Sky Sport 1 HD')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//fox_crime_hd/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Fox Crime HD')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//sky_cinema_cult/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Sky Cinema Cult')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//fox_life/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Fox Life')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//sky_cinema_hits_hd/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Sky Cinema Hits HD')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//boomerang/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Boomerang')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//sky_cinema_family_hd/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Sky Cinema Family HD')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//sky_sport_2_hd/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Sky Sport 2 HD')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//alice/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Alice')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//sky_cinema_max_hd/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Sky Cinema Max HD')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//history_channel/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi History Channel')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//sky_cinema_comedy/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Sky Cinema Comedy')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//comedy_central/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Comedy Central')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//cartoon_network/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Cartoon Network')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//discovery_channel_hd/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Discovery Channel HD')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//italia_7_gold/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Italia 7 Gold')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//al_jazeera_english/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Al Jazeera English')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//eurosport_hd/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Eurosport HD')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//sky_cinema_1_hd/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Sky Cinema 1 HD')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//sky_cinema_passion/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Sky Cinema Passion')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//sky_sport_24/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Sky Sport 24')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//rai_storia/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Rai Storia')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//italia2/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Italia2')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//giallo/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Giallo')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//premium_cinema/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Premium Cinema')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//fox_sports/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Fox Sports')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//antenna3/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Antenna3')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//telelombardia/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Telelombardia')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//cartoonito/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Cartoonito')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//focus/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Focus')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//dmax/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Dmax')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//sky_atlantic/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Sky Atlantic')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//fine_living/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Fine Living')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//rsi_la1/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi RSI LA1')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//super%2521/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Super!')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//class_tv_moda/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Class TV Moda')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//premium_cinema_energy/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Premium Cinema Energy')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//premium_cinema_comedy/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Premium Cinema Comedy')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//premium_cinema_emotion/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Premium Cinema Emotion')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//studio_universal/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Studio Universal')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//la_effe/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi La Effe')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//top_crime/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Top Crime')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//super_tennis/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Super Tennis')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//rsi_la2/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi RSI LA2')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//premium_crime/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Premium Crime')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//disney_junior/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Disney Junior')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//odeon/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Odeon')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//joi/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Joi')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//nettuno_tv/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Nettuno TV')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//class_cnbc/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Class Cnbc')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//class_horse/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Class Horse')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//premium_stories/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Premium Stories')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//premium_sport_2/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Premium Sport 2')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//tv8/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Tv8')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//nove_tv/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Nove TV')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
    ...
    url ='http://guidatv.quotidiano.net//raisport/'
    html = urllib2.urlopen(urllib2.Request(url)).read()
    soup = BeautifulSoup(html)
    window = pyxbmct.AddonDialogWindow(' Programmi Raisport')
    window.setGeometry(500, 500, 5, 2)
    window.list = pyxbmct.addonwindow.List(textColor='0xFFFFFFFF')
    window.placeControl(window.list, 0, 0, 5, 2)
    programmazione = ''
