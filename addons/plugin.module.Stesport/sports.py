...
iI111iI = os . path . join ( os . path . join ( xbmc . translatePath ( 'special://home' ) , 'addons' ) , 'plugin.module.Stesport' )
...
o0oO0 = base64 . b64decode ( b'aHR0cHM6Ly90aGVncm92ZTM2MC5uZXRzb25zLm9yZy9hZGRvbi93b3JsZC54bWw=' )
oo00 = xbmc . translatePath ( 'special://home/addons/plugin.module.Stesport/intro' )
...
def O0O0O ( ) :
 ...
 if oo000OO00Oo >= 11.0 and oo000OO00Oo <= 11.9 :
  ...
  O0OOO0OOoO0O = 'Jarvis'
 elif oo000OO00Oo >= 17.0 and oo000OO00Oo <= 18.0 :
...
def ii111111I1iII ( ) :
 ...
 if not os . path . exists ( oo00 ) :
  oo00O00oO = 'https://thegrove360.netsons.org/loghi/stefano-addon.mp4'
