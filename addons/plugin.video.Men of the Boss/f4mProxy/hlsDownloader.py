...
def getUrl(url,timeout=20,returnres=False):
    ...
    try:
        ...
        headers = {'User-Agent': 'Android / Chrome 40: Mozilla/5.0 (Linux; Android 5.1.1; Nexus 4 Build/LMY48T) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.89 Mobile Safari/537.36'}
        if clientHeader:
...
def getUrlold(url,timeout=20, returnres=False):
    ...
    try:
        ...
        if not ua_header:
            req.add_header('User-Agent','Android / Chrome 40: Mozilla/5.0 (Linux; Android 5.1.1; Nexus 4 Build/LMY48T) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.89 Mobile Safari/537.36')
