...
addon = xbmcaddon.Addon('plugin.video.PLANET ANDROID MANIA')
...
SOURCES = [{"title": "PLANET ANDROID MANIA ", "url": a, "fanart": "https://", "genre": "Live Tv", "date": "19.11.2017", "credits": "MadDog", "thumbnail": "https://"}]
...
#            print 'parentalblockedpin',parentalblockedpin
            ...
            if showcontext == 'source':
                ...
                contextMenu.append(('Remove from PLANET ANDROID MANIA Favorites','XBMC.RunPlugin(%s?mode=6&name=%s)'
            ...
            if not name in FAV:
                contextMenu.append(('Add to PLANET ANDROID MANIA Favorites','XBMC.RunPlugin(%s?mode=5&name=%s&url=%s&iconimage=%s&fanart=%s&fav_mode=%s)'
...
def makeRequest(url, headers=None):
        try:
            if headers is None:
                headers = {'User-agent' : 'PLANET ANDROID MANIA'}
            ...
            if hasattr(e, 'code'):
                ...
                xbmc.executebuiltin("XBMC.Notification(PLANET ANDROID MANIA,We failed with error code - "+str(e.code)+",10000,"+icon+")")
            elif hasattr(e, 'reason'):
                addon_log('We failed to reach a server.')
                addon_log('Reason: %s' %e.reason)
                xbmc.executebuiltin("XBMC.Notification(PLANET ANDROID MANIA,We failed to reach a server. - "+str(e.reason)+",10000,"+icon+")")
...
def addSource(url=None):
        ...
        xbmc.executebuiltin("XBMC.Notification(PLANET ANDROID MANIA,New source added.,5000,"+icon+")")
        if not url is None:
...
if os.path.exists(oslinux):
    ...
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a PLANET ANDROID MANIA. Errore #001')
    killxbmc()
...
if os.path.exists(oslinux):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a PLANET ANDROID MANIA. Errore #002')
    killxbmc()
...
if os.path.exists(oslinux):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a PLANET ANDROID MANIA. Errore #003')
    killxbmc()
...
if os.path.exists(osandroid):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a PLANET ANDROID MANIA. Errore #004')
    killxbmc()
    killkodi()
...
if os.path.exists(osandroid):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a PLANET ANDROID MANIA. Errore #005')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
if os.path.exists(oswindows):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a PLANET ANDROID MANIA. Errore #006')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
if os.path.exists(oswindows):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a PLANET ANDROID MANIA. Errore #007')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
if os.path.exists(oswindows):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a PLANET ANDROID MANIA. Errore #008')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
if os.path.exists(oswindows):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a PLANET ANDROID MANIA. Errore #009')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
if os.path.exists(oswindows):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a PLANET ANDROID MANIA. Errore #010')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
if os.path.exists(oswindows):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a PLANET ANDROID MANIA. Errore #011')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
if os.path.exists(oswindows):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a PLANET ANDROID MANIA. Errore #012')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')	
...
def urlsolver(url):
    ...
    if host:
        ...
        xbmc.executebuiltin("XBMC.Notification(PLANET ANDROID MANIA,Urlresolver donot support this domain. - ,5000)")
        resolver=url
    return resolver
...
def download_file(name, url):
        if addon.getSetting('save_location') == "":
            xbmc.executebuiltin("XBMC.Notification('PLANET ANDROID MANIA','Choose a location to save files.',15000,"+icon+")")
            addon.openSettings()
        params = {'url': url, 'download_path': addon.getSetting('save_location')}
        downloader.download(name, params)
        dialog = xbmcgui.Dialog()
        ret = dialog.yesno('PLANET ANDROID MANIA', 'Do you want to add this file as a source?')
        if ret:
...
#                print 'setting as folder in link'
        ...
        if showcontext:
            ...
            if showcontext == 'fav':
                contextMenu.append(
                    ('Remove from PLANET ANDROID MANIA Favorites','XBMC.RunPlugin(%s?mode=6&name=%s)'
                     %(sys.argv[0], urllib.quote_plus(name)))
                     )
                ...
                contextMenu.append(('Add to PLANET ANDROID MANIA Favorites','XBMC.RunPlugin(%s)' %fav_params))
            liz.addContextMenuItems(contextMenu)
...
#            ln+='</item>'
        ...
        if url:
            ...
            xbmc.executebuiltin("XBMC.Notification(PLANET ANDROID MANIA,Failed to extract regex. - "+"this"+",4000,"+icon+")")
    ...
    try:
        ...
        xbmc.executebuiltin("XBMC.Notification(PLANET ANDROID MANIA,Please [COLOR yellow]install Youtube-dl[/COLOR] module ,10000,"")")
    ...
    if not (keyboard.isConfirmed() == False):
        ...
        if newStr==parentalblockedpin:
            ...
            xbmc.executebuiltin("XBMC.Notification(PLANET ANDROID MANIA,Parental Block Disabled,5000,"+icon+")")
        else:
            xbmc.executebuiltin("XBMC.Notification(PLANET ANDROID MANIA,Wrong Pin??,5000,"+icon+")")
    xbmcplugin.endOfDirectory(int(sys.argv[1]))

elif mode==56:
    addon_log("disable lock")
    addon.setSetting('parentalblocked', "false")
    xbmc.executebuiltin("XBMC.Notification(PLANET ANDROID MANIA,Parental block enabled,5000,"+icon+")")
    xbmcplugin.endOfDirectory(int(sys.argv[1]))
