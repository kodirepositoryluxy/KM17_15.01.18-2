...
def get_video_url( page_url , premium = False , user="" , password="", video_password="" ):
    logger.info("streamondemand.servers.cnubis page_url="+page_url)
    video_urls = []
    ...
    for video_url in video_urls:
       logger.info("streamondemand.servers.cnubis %s - %s" % (video_url[0],video_url[1]))
...
def find_videos(text):
    ...
    logger.info("streamondemand.servers.cnubis find_videos #"+patronvideos+"#")
