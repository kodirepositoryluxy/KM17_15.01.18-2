...
def test_video_exists(page_url):
    logger.info("streamondemand.servers.allmyvideos test_video_exists(page_url='%s')" % page_url)
...
def find_videos(data):
    ...
    logger.info("streamondemand.servers.allmyvideos find_videos #" + patronvideos + "#")
