...
def channels_list():
    ...
    itemlist.append( Item( title="[COLOR azure]AltaDefinizione01_video[/COLOR]"      , channel="altadefinizione01_video"           , language="IT"    , category="B,F,A,VOS"   , type="generic"))
    ...
    itemlist.append( Item( title="[COLOR azure]AltadefinizioneHD[/COLOR]" , channel="altadefinizionehd" , language="IT" , category="B,F" , type="generic"))
    ...
    itemlist.append( Item( title="[COLOR azure]GuardaFilm[/COLOR]"         , channel="guardafilm"           , language="IT"    , category="F"    , type="generic"))
    ...
    #itemlist.append( Item( title="[COLOR azure]italiaserienews[/COLOR]"        , channel="italiaserienews"           , language="IT"    , category="S"   , type="generic"))
    ...
    itemlist.append( Item( title="[COLOR azure]Tantifilm[/COLOR]"        , channel="tantifilm"       , language="IT"    , category="B,F,3"       , type="generic"))
