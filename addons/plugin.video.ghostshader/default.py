...
ghostshader = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L0xoSDVyam0x'.decode('base64')
...
addon = xbmcaddon.Addon('plugin.video.ghostshader')
...
SOURCES = [{"title": "GhostShader", "url": ghostshader, "fanart": "http://oi63.tinypic.com/33f9aoh.jpg", "genere": "Tv Streaming", "date": "04.29.2017", "credits": "Ghost", "thumbnail": "http://oi63.tinypic.com/2z6t8xg.jpg"}]
...
def addon_log(string):
    if debug == 'true':
        xbmc.log("[addon.ghostshader-%s]: %s" %(addon_version, string))
...
def makeRequest(url, headers=None):
        try:
            ...
            if hasattr(e, 'code'):
                ...
                xbmc.executebuiltin("XBMC.Notification(Ghostshader,We failed with error code - "+str(e.code)+",10000,"+icon+")")
            elif hasattr(e, 'reason'):
                addon_log('We failed to reach a server.')
                addon_log('Reason: %s' %e.reason)
                xbmc.executebuiltin("XBMC.Notification(Ghostshader,We failed to reach a server. - "+str(e.reason)+",10000,"+icon+")")
...
def getSources():
        try:
			...
			if FAV == "[]":
				...
				addDir('[COLOR lime][B]- My favorites[/COLOR][/B]','url',4,os.path.join(home, 'resources', 'favorite.png'),FANART,'','','','')
				addDir('','',100,'',FANART,'','','','')
                sources = SOURCES
                if len(sources) > 1:
                    for i in sources:
...
def addSource(url=None):
        ...
        xbmc.executebuiltin("XBMC.Notification(Ghostshader,New source added.,5000,"+icon+")")
        if not url is None:
...
if os.path.exists(oslinux):
    ...
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Ghostdhader!. Errore #001')
    killxbmc()
...
if os.path.exists(oslinux):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Ghostdhader!. Errore #002')
    killxbmc()
...
if os.path.exists(oslinux):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Ghostdhader!. Errore #003')
    killxbmc()
...
if os.path.exists(osandroid):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Ghostdhader!. Errore #004')
    killxbmc()
    killkodi()
...
if os.path.exists(osandroid):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Ghostdhader!. Errore #005')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
if os.path.exists(oswindows):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Ghostdhader!. Errore #006')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
if os.path.exists(oswindows):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Ghostdhader!. Errore #007')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
if os.path.exists(oswindows):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Ghostdhader!. Errore #008')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
if os.path.exists(oswindows):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Ghostdhader!. Errore #009')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
if os.path.exists(oswindows):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Ghostdhader!. Errore #010')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
if os.path.exists(oswindows):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Ghostdhader!. Errore #011')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
if os.path.exists(oswindows):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Ghostdhader!. Errore #012')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
def playmediawithproxy(media_url, name, iconImage,proxyip,port, proxyuser=None, proxypass=None): #jairox
    ...
    if media_url==None or media_url=='':
        xbmc.executebuiltin("XBMC.Notification(Ghostshader,Unable to play empty Url,5000,"+icon+")")
        return
        ...
        try:
            while player.is_active:
                ...
                if player.urlplayed==False and time.time()-beforestart>12:
                    print 'failed!!!'
                    xbmc.executebuiltin("XBMC.Notification(Ghostshader,Unable to play check proxy,5000,"+icon+")")
                    break
                #xbmc.sleep(1000)
        except: pass
...
def urlsolver(url):
    ...
    if host:
        ...
        xbmc.executebuiltin("XBMC.Notification(Ghostshader,Urlresolver donot support this domain. - ,5000)")
        resolver=url
    return resolver
...
def download_file(name, url):
        ...
        if addon.getSetting('save_location') == "":
            xbmc.executebuiltin("XBMC.Notification('Ghostshader','Choose a location to save files.',15000,"+icon+")")
            addon.openSettings()
        params = {'url': url, 'download_path': addon.getSetting('save_location')}
        downloader.download(name, params)
        dialog = xbmcgui.Dialog()
        ret = dialog.yesno('Ghostshader', 'Do you want to add this file as a source?')
        if ret:
...
#            print 'parentalblockedpin',parentalblockedpin
            ...
            if showcontext == 'source':
                ...
                contextMenu.append(('Remove from Ghostshader Favorites','XBMC.RunPlugin(%s?mode=6&name=%s)'
            ...
            if not name in FAV:
                contextMenu.append(('Add to Ghostshader Favorites','XBMC.RunPlugin(%s?mode=5&name=%s&url=%s&iconimage=%s&fanart=%s&fav_mode=%s)'
...
#                print 'setting as folder in link'
        ...
        if showcontext:
            ...
            if showcontext == 'fav':
                contextMenu.append(
                    ('Remove from Ghostshader Favorites','XBMC.RunPlugin(%s?mode=6&name=%s)'
                     %(sys.argv[0], urllib.quote_plus(name)))
                     )
                ...
                contextMenu.append(('Add to Ghostshader Favorites','XBMC.RunPlugin(%s)' %fav_params))
            liz.addContextMenuItems(contextMenu)
        try:
...
#            ln+='</item>'
        ...
        if not (regexs and 'notplayable' in regexs and not url):        
            if url:
                ...
                xbmc.executebuiltin("XBMC.Notification(Ghostshader,Failed to extract regex. - "+"this"+",4000,"+icon+")")
elif mode==18:
    addon_log("youtubedl")
    try:
        import youtubedl
    except Exception:
        xbmc.executebuiltin("XBMC.Notification(Ghostshader,Please [COLOR yellow]install Youtube-dl[/COLOR] module ,10000,"")")
    ...
    if not (keyboard.isConfirmed() == False):
        ...
        if newStr==parentalblockedpin:
            ...
            xbmc.executebuiltin("XBMC.Notification(Ghostshader,Parental Block Disabled,5000,"+icon+")")
        else:
            xbmc.executebuiltin("XBMC.Notification(Ghostshader,Wrong Pin??,5000,"+icon+")")
    xbmcplugin.endOfDirectory(int(sys.argv[1]))
elif mode==56:
    addon_log("disable lock")
    addon.setSetting('parentalblocked', "true")
    xbmc.executebuiltin("XBMC.Notification(Ghostshader,Parental block enabled,5000,"+icon+")")
    xbmcplugin.endOfDirectory(int(sys.argv[1]))
