...
def startup_freshstart():
    ...
    if yes_pressed:
        ...
        keep_steman = kodi.yesnoDialog(AddonTitle,
                                       "Do you wish to keep steman installed for convenience after the factory restore?",
                                       " ")
        if keep_steman:
            sub_dir_exclude = sub_dir_exclude + ('plugin.program.steman',)
