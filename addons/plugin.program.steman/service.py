...
kodi.log('STARTING STEMAN SERVICE')
...
indisettingspath = xbmcPath+'/userdata/addon_data/plugin.program.steman/settings.xml'
...
if __name__ == '__main__':
    ...
    while not monitor.abortRequested():
        ...
        if kodi.get_setting ('scriptblock') == 'true':
            ...
            BlocksUrl = base64.b64decode('aHR0cHM6Ly9zdGVmYW5vYWRkb24uaW5mby9zdGVtYW4vYmxvY2tlci50eHQ=')
