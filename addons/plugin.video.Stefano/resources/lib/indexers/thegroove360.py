...
class indexer:
    ...
    def addSearch(self, url):
            ...
            link = 'https://stefanoaddon.info/addon/search.xml'
    ...
    def Stefano_list(self, url, result=None):
        ...
        try:
            ...
            api_data = client.request(base64.b64decode('aHR0cHM6Ly93d3cuc3RlZmFub2FkZG9uLmluZm8vYWRkb24vYXBpL3RtZGItYXBpLnR4dA=='), timeout='5')
